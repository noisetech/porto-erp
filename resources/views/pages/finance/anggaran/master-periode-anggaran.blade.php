...
@section('title', 'Finance-Periode-Anggaran')
@section('content')
...
<div class="container-fluid">
    <div class="inner-contents">
        <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
            <div class="left-part">
                <h2 class="text-dark">Periode Anggaran</h2>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Periode Anggaran</h5>
            ...
            <div class="modal-body">
                <form action="#" id="form-simpan" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Ketikan tahun" name="tahun" class="form-control"></input>
                                <span id="tahun_error" class="text-danger error-text my-2">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_mulai" class="form-control"></input>
                                <span id="tanggal_mulai_error" class="text-danger error-text my-2">
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_selesai" class="form-control"></input>
                                <span id="tanggal_selesai_error" class="text-danger error-text my-2">
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" class="form-control" placeholder="Ketikan keterangan" style="height: 200px !important;" id=""></textarea>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-simpan').on('submit', function(e) {
            ...
            $.ajax({
                url: '{{ route("finance.master_periode_anggaran.simpan") }}',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
